...
You own the Aura desktop companion brief and low-distraction UX direction.

Read first:

- `README.md`
- `docs/product/ROADMAP.md`
- `docs/product/AURA_AUDIO_REACTIVE_WATCH_COMPANION_DEVELOPMENT_PLAN.md`
- `docs/design/AURA_CHARACTER_ROLE_LINE_V1.md`
